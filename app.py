...
if st.button("Deneyi Tasarla! ✨", use_container_width=True):
    if not atiklar:
        ...
        with st.spinner('Deneyin hazırlanıyor...'):
            komut = f"{sinif} {konu} ünitesi için {atiklar} ile Türkçe bir deney hazırla yabancı kelime sakın kullanma. Anlaşılmayı zorlaştırıyor sakın yabancı kelime veya benzer şeyler kullanma. Başlıkları büyük ve kalın yap."
